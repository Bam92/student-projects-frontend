...
function BarProjet() {
	...
	return (
		<section className='  mb-9 flex'>
			<div className='flex mx-auto  max-[680px]:mx-auto max-[680px]:mt-[5%] mt-[2%] max-[680px]:text-[12px] z-50   justify-between p-1 rounded-full shadow-lg items-center bg-[#303030]'>
				{tech &&
					tech.map((techno, key) => (
						<span
							onClick={() => {
